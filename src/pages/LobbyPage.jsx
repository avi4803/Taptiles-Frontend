...
const LobbyPage = ({ onGameStart }) => {
    ...
    const { createGame, joinGame, startGame, leaveGame, isCreating, isJoining, error, clearError, resetLoadingStates } = useGameActions();
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-gray-900 dark:text-white h-screen w-full overflow-hidden selection:bg-primary selection:text-white">
            ...
            <main className="relative z-10 flex flex-col h-screen max-w-7xl mx-auto px-4 md:px-6 py-6 overflow-hidden">
                ...
                {/* Content Grid */}
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 flex-1 overflow-y-auto lg:overflow-hidden pb-4">
                    {/* Action Panels - Side by side on mobile, Stacked on Desktop */}
                    <div className="w-full lg:w-1/3 shrink-0">
                        <div className="grid grid-cols-2 lg:flex lg:flex-col gap-3 lg:gap-6">
                            <CreateGamePanel onCreateClick={openCreateModal} />
                            <JoinGamePanel
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col flex-1 min-h-[400px] lg:h-full overflow-hidden">
                        <GameList
